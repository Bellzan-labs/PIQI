...
2. [Install Claude Code Desktop](#2-install-claude-code-desktop)
...
> **Summary:** Claude Code is an AI coding assistant that runs locally and helps you write code, debug issues, and manage your project. It connects to Claude (Anthropic's AI) and has access to tools like file editing, terminal commands, web search, and deployment services. Think of it as a senior developer sitting next to you.

### Install

1. Go to https://claude.ai/download and download **Claude Code** for your OS
2. Run the installer
3. Open Claude Code — it will ask you to sign in with your Anthropic account
4. If you don't have an account, create one at https://claude.ai/
...
2. **Create a CLAUDE.md file** in the project root — this is the instruction file that tells Claude about your project:
   ```markdown
   ...
   ```
3. Claude Code reads this file automatically and follows its instructions in every conversation

### Key Claude Code Features

| Feature | What It Does |
|---------|-------------|
| **Chat** | Ask questions, request code changes, debug errors |
| **File editing** | Claude can read and edit your project files directly |
| **Terminal** | Claude can run commands like `npm install`, `npm run dev` |
| **MCP Servers** | Connectors to external services (Vercel, GitHub, Supabase) |
| **Memory** | Claude remembers project context across conversations |
| **/commands** | Shortcuts like `/commit` (create git commit), `/review-pr` |

### Connect MCP Servers (Optional but Recommended)

MCP (Model Context Protocol) servers let Claude interact with external services. In Claude Code settings, you can connect:

- **Vercel** — deploy and manage your site directly from chat
- **Context7** — verify library syntax and get up-to-date documentation
- **GitHub** — manage repos, PRs, issues from chat

These are configured in the Claude.ai UI under Settings > MCP Servers.
...
- **In Claude Code**: just describe your problem — Claude can read your files, run commands, and suggest fixes
